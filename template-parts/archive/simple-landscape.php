<div id="simple-landscape" class="list">
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<article role="article">
			<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" class="article">
				<?php if(is_front_page()): ?>
					<?php if(get_theme_mod('front_eyecatch_state','enabled') == 'enabled'): get_template_part('template-parts/part/eyecatch'); endif; ?>
				<?php else: ?>
					<?php if(get_theme_mod('archive_eyecatch_state','enabled') == 'enabled'): get_template_part('template-parts/part/eyecatch'); endif; ?>
				<?php endif; ?>
