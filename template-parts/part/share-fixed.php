...
?>
<div id="share" class="fixed <?php echo get_theme_mod('share_design','circle'); ?> <?php echo get_theme_mod('share_color','brand'); ?> " data-wow-delay="0.5s">
	<ul>
...
<script>
$(function () {
	var $shareFixedBody = $('#share.fixed'),
	$shareFixd = $('#share.fixed'),
	shareFixdOffsetTop = $shareFixd.offset().top;
	$(window).on('scroll', function () {
	if($(this).scrollTop() > shareFixdOffsetTop) {
	$shareFixedBody.addClass('is-fixed');
	} else {
	$shareFixedBody.removeClass('is-fixed');
	}
	});
	});
</script>